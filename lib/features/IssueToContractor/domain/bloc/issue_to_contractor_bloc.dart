...
import 'package:bsppl/features/IssueToContractor/domain/bloc/issue_to_contractor_event.dart';
import 'package:bsppl/features/IssueToContractor/domain/bloc/issue_to_contractor_state.dart';
import 'package:bsppl/features/IssueToContractor/domain/model/section_name_model.dart';
import 'package:bsppl/features/IssueToContractor/helper/issue_to_contractor_helper.dart';
...
class IssueToContractorBloc extends Bloc<IssueToContractorEvent,IssueToContractorState>{
  ...
  yardName({required BuildContext context}) async{
    var res = await IssueToContractorHelper.sectionNameData(context: context,sectionId: "2");
    if(res != null){

...
import 'package:bsppl/features/UT/Engineer/domain/bloc/ut_event.dart';
import 'package:bsppl/features/UT/Engineer/domain/bloc/ut_state.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:intl/intl.dart';

class UTBloc extends Bloc<UTEvent,UTState>{
  UTBloc() : super(UTInitialState()){
    on<UTPageLoadEvent>(_pageLoad);
  ...
  _pageLoad(UTPageLoadEvent event, emit) {
    emit(UTPageLoadState());
    _isPageLoader = false;
  ...
  _eventComplete(Emitter<UTState>emit) {
    emit(UTFetchDataState(
